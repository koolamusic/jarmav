	...
	$(window).load(function(e) {
		...
		var showContent = setTimeout(function(){
			...
			$("#wordrotator").wordsrotator({
    			...
    			words: ['we design<br><span class="highlight">brand websites</span>', 'we create<br><span class="highlight">marketing solutions</span>', 'we redefine<br><span class="highlight">brand identities</span>', 'we anchor<br><span class="highlight">your events</span>']  	//-- Array of words, it may contain HTML values
			});
